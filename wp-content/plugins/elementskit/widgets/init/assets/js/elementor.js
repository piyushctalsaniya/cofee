! function(e, t) {
    ...
    }), "function" != typeof ElementsKit_Helper.removeSpecificCharacters && (ElementsKit_Helper.removeSpecificCharacters = function(e) {
    ...
    let i = {
        ...
        Advanced_Accordion: function(t) {
            t.find(".elementskit-card > .collapse").on("shown.bs.collapse", (function() {
                var n = e(this);
                n.is(".elementskit-card > .collapse") && n.css({
                    height: "auto"
        ...
        MotionText: function(t) {
            ...
            ElementsKit_Helper ? .observeElement(i[0], (t => {
        ...
        Unfold: function(t) {
            ...
            o.collapse_height >= s.outerHeight() && (i.hide(), a.addClass("active")), i.on("click", (function() {
                ...
                }, parseInt(o.transition_duration, 10) || 0), i.html(ElementsKit_Helper.removeSpecificCharacters(o.expand_text))) : (a.animate({
                    height: s.outerHeight()
                }, parseInt(o.transition_duration, 10) || 0), i.html(ElementsKit_Helper.removeSpecificCharacters(o.collapse_text))), a.toggleClass("active"), a.hasClass("active") || setTimeout((() => {
                    a[0].scrollIntoView({
                        block: "center"
                    })
        ...
        TimeLine: function(t) {
            t.find(".elementskit-invisible").each((function() {
                ElementsKit_Helper ? .observeElement(this, (t => {
            ...
            let i = null;
            t.find(".horizantal-timeline > .single-timeline").hasClass("hover") || t.find(".horizantal-timeline > .single-timeline").first().addClass("hover").siblings().removeClass("hover"), t.on("mouseenter", ".horizantal-timeline > .single-timeline", (function() {
                e(this).addClass("hover").siblings().removeClass("hover"), i = e(this)
        ...
        Video_Gallery: function(i) {
            ...
            if (n.length > 0 && n.magnificPopup({
                    ...
                    callbacks: {
                        open: function() {
                            e("body").find(".mfp-close").addClass("ekit-popup-close"), window.dispatchEvent(new Event("resize")), r(e(".mfp-iframe"))
                        },
                        close: function() {
                            e("body").find(".mfp-close").removeClass("ekit-popup-close"), i.find("video").each((function() {
                                this.pause()
                            }))
                        }
                    },
                    ...
                    e(this).addClass("video-added").append('<iframe src="' + i + '" width="643" height="360" allow="autoplay" frameborder="0"></iframe>'), r(e(this).find("iframe"), 10)
        ...
        Advanced_Slider: function(i) {
            ...
            var l = {
                ...
                on: {
                    init: function() {
                        c(this), d(this), "yes" === o ? .sliderOptions.sliderThumbsShow && function() {
                            let {
                                sliderOptions: t
                            } = o, a = i.find(".swiper-pagination.ekit-swiper-pagination"), s = a.children(), l = t.sliderTabItems.map((e => e.ekit_slider_thumbs_image.url)), r = s.length, d = {
                                display: "grid"
                            };
                            s.each((function(t) {
                                const i = e(this);
                            ...
                            })), "horizontal" === t.sliderDirectionType ? (d.width = t.sliderThumbsOffset.size ? `${t.sliderThumbsOffset.size}%` : "70%", d.gridTemplateColumns = `repeat(${r}, 1fr)`, d.gridTemplateRows = "1fr", d.marginTop = "7px") : (d.gridTemplateColumns = "1fr", d.gridTemplateRows = `repeat(${r}, 1fr)`);
            ...
            "horizontal" == o.sliderOptions.sliderDirectionType ? (l.slidesPerView = o.sliderOptions.slidesPerViewItem, l.spaceBetween = o.sliderOptions.spaceBetweenGap, l.breakpoints = o.sliderOptions.breakpointsOption) : l.slidesPerView = 1, "yes" != o.sliderOptions.sliderAutoPlay && "yes" != o.sliderOptions.progressBar || (l.autoplay = {
                delay: o ? .sliderOptions.autoPlayDelay || 3e3
            }, o ? .sliderOptions ? .pauseOnMouseEnter && n.hover((function() {
            ...
            ElementsKit_Helper.swiper(r, l).then((function(e) {})), "yes" == o.sliderOptions.progressBar && (i.find(".ekit-slider-wrapper, .ekit-swiper-progress").each((function(t, i) {
                e(i).on("mouseenter", (function() {
                    o ? .sliderOptions ? .pauseOnMouseEnter && s.css({
            ...
            if ("animated" === i.animationStyle) {
                ...
                function u(e) {
                    ...
                    if (e.parents(".ekit-fancy-text").hasClass("type")) {
                        ...
                        v(e, t), h(e.find("i").eq(0), e, p, o), k(t.find("i").eq(0), t, p, o)
        ...
        Interactive_Links: function(t) {
            ...
            function a() {
                t.find(".ekit-interactive-links-list-link-title-container").each((function(t, i) {
                    let n = e(i),
                        a = n.data("image");
                    n.closest(".ekit-interactive-active").length ? n.css("background-image", `url(${a})`) : n.css("background-image", "none")
                }))
            }
