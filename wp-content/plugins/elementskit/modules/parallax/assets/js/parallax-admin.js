            ...
            78: function() {
                ! function(e, t) {
                    ...
                    var i = function(n) {
                        ...
                        i.init = function() {
                            ...
                            if (a = i.getOptions(t, "ekit_section_parallax_multi_items"), "yes" == (o = i.getOptions(t, "ekit_section_parallax_multi"))) {
                                ...
                                if (n.addClass("elementskit-parallax-multi-container"), e.each(a, (function(e, t) {
                                        t.hasOwnProperty("attributes") && (t = t.attributes), r.push(t), i.pushElement(t), i.getSVG()
                                    })), r.length < 0) return r;
                            ...
                            var t, o;
                            t = i.getOptions(e, "ekit_section_parallax_bg"), o = i.getOptions(e, "ekit_section_parallax_bg_speed"), "yes" == t && (n.addClass("elementskit-parallax-multi-container"), "yes" != t || s || n.jarallax({
                                speed: o
                            }))
                            ...
                            var t = "ekit-section-parallax-mousemove ekit-section-parallax-layer elementor-repeater-item-" + e._id,
                                o = "";
                            "shape" == e.item_source && (e.image = {}, e.image.url = window.elementskit_module_parallax_url + "assets/svg/" + e.shape + ".svg", t += " ekit-section-parallax-layer-shape", o = "shape-" + e.shape.replace(".svg", ""));
                            var s = i.escapeString(t),
                                a = i.escapeString(e.parallax_style),
                                r = i.escapeString(o),
                                l = i.escapeString(e.image.url),
                                m = i.escapeString(e.image.alt);
                            0 === n.find(".elementor-repeater-item-" + e._id).length && "" != e.image.url && n.prepend(`\n\t\t\t\t\t<div class="${s} ekit-section-parallax-type-${a}" role="img" aria-label="${m}">\n\t\t\t\t\t\t<img\n\t\t\t\t\t\tclass="elementskit-parallax-graphic ${r}"\n\t\t\t\t\t\tsrc="${l}"\n\t\t\t\t\t\talt="${m}"\n\t\t\t\t\t\t/>\n\t\t\t\t\t</div>\n\t\t\t\t`)
                        }, i.getSVG = function() {
                        ...
                        }, i.escapeString = e => String(e).replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;").replace(/"/g, "&quot;").replace(/'/g, "&#039;")
                    }
                ...
                ! function(e, t) {
                    ...
                    var i = "undefined" != typeof window.elementorFrontend.version && function(e, t) {
                        ...
                        o = i.extend({
                            ...
                            tilt: function() {
                                this.contentElementFinder().tilt({
                            ...
                            mousemove: function() {
                                var e = this.contentElementFinder(),
                            ...
                            contentElementFinder: function() {
                                let e = this.$element.find(".elementor-widget-container");
                                return 0 === e.length && (e = this.$element.find(".elementor-element:not(:has(.elementor-widget-container))")), e
                            }
                        })
                }(jQuery, window.elementorFrontend)
            }
