    ...
    let n = {
        ...
        Image_Accordion: function(t) {
            ...
            t.on("click", ".ekit-image-accordion-item", (function(t) {
                ...
                if ("hover" === a || i === this) !l && s ? .url && ElementsKit_Helper.isValidURL(s.url) && window.open(s.url, r);
                else {
        ...
        Countdown_Timer: function(t) {
            ...
            for (let e in i) i.hasOwnProperty(e) && "string" == typeof i[e] && (i[e] = i[e]);
            if (n.length) {
            ...
            if (n.length > 0) {
                const o = {
                    ...
                    callbacks: {
                        ...
                        close: function() {
                            s.find(".mfp-close").removeClass("ekit-popup-close"), e.find("video").each((function() {
                                this.pause()
                            }))
                        }
                    }
